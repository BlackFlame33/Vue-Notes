                    ...
                    <nav class="collapse navbar-collapse clearfix" role="navigation">
                        <ul class="nav navbar-nav navbar-right">
                            <li class="dropdown active">
                                <router-link to="/" class="dropdown-toggle" data-toggle="dropdown">Home <i class="fa fa-angle-down"></i></router-link>
                            ...
                            <li class="dropdown">
                                <router-link to="/" class="dropdown-toggle" data-toggle="dropdown">Company <i class="fa fa-angle-down"></i></router-link>
                                <div class="dropdown-menu">
                                    <ul>
                            ...
                            <li class="dropdown">
                                <router-link to="/" class="dropdown-toggle" data-toggle="dropdown">Portfolio <i class="fa fa-angle-down"></i></router-link>
                                <div class="dropdown-menu">
                                    <ul>

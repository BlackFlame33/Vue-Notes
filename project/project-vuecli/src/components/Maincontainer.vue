            ...
            <div class="post-content">
              ...
              <div class="row">
                <div
                  ...
                  data-wow-delay=".5s"
                >
                  <span class="feature-icon pull-left"><i class="fa fa-heart-o" /></span>
                ...
                <div
                  ...
                  data-wow-delay=".5s"
                >
                  <span class="feature-icon pull-left"><i class="fa fa-codepen" /></span>
                  <div class="feature-content">
              ...
              <div class="row">
                <div
                  ...
                  data-wow-delay=".5s"
                >
                  <span class="feature-icon pull-left"><i class="fa fa-newspaper-o" /></span>
                  <div class="feature-content">
                ...
                <div
                  ...
                  data-wow-delay=".5s"
                >
                  <span class="feature-icon pull-left"><i class="fa fa-desktop" /></span>
                  <div class="feature-content">

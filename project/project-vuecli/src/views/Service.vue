...
Recent Posts
              ...
              <div class="latest-post-items media">
                <div class="latest-post-content media-body">
                  ...
                  <p class="post-meta">
                    <span class="date">
                      <i class="icon icon-calendar" /> Mar 15, 2015
                    </span>
                    <span class="post-meta-comments">
                      <i class="icon icon-bubbles4" />
                      <a href="#">03</a>
                    </span>
                  </p>
                </div>
              ...
              <div class="latest-post-items media">
                <div class="latest-post-content media-body">
                  ...
                  <p class="post-meta">
                    <span class="date">
                      <i class="icon icon-calendar" /> Apr 17, 2015
                    </span>
                    <span class="post-meta-comments">
                      <i class="icon icon-bubbles4" />
                      <a href="#">14</a>
...
data-rel="prettyPhoto" href="images/gallery/1.jpg">
                    <img src="images/gallery/1.jpg"
alt>
                  </a>
                  <a class="thumb-holder"
data-rel="prettyPhoto" href="images/gallery/2.jpg">
                    <img src="images/gallery/2.jpg"
alt>
                  </a>
                  <a class="thumb-holder"
data-rel="prettyPhoto" href="images/gallery/3.jpg">
                    <img src="images/gallery/3.jpg"
alt>
                  </a>
                  <a class="thumb-holder"
data-rel="prettyPhoto" href="images/gallery/4.jpg">
                    <img src="images/gallery/4.jpg"
alt>
                  </a>
                  <a class="thumb-holder"
data-rel="prettyPhoto" href="images/gallery/5.jpg">
                    <img src="images/gallery/5.jpg"
alt>
                  </a>
                  <a class="thumb-holder"
data-rel="prettyPhoto" href="images/gallery/6.jpg">
...
href="#">
          ...
          <!--/ Row end -->
          <div id="back-to-top"
data-spy="affix" data-offset-top="10" class="back-to-top affix">

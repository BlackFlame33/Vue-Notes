                        ...
                        <div class='post-content'>
                            ...
                            <div class='post-header clearfix'>
                                <h2 class='post-title'>
                                    <a
                                        href='blog-item.html'
                                    >Over the year we have lots of experience in our field</a>
                                </h2>
                                <div class='post-meta'>
                            ...
                            <div class='about-author'>
                                ...
                                <div class='author-info'>
                                    ...
                                    <p class='author-url'>
                                        Website:
                                        <span>
                                            <a href='#'>http://www.spikeincor.eu</a>
                                        </span>
                                    </p>
                                </div>
                            </div>
                                            ...
                                            <li>
                                                <div class='comment'>
                                                    <img
                                                        class='comment-avatar pull-left'
                                                        alt='img'
                                                        src='images/blog/avator2.jpg'
                                                    >
                                                    <div class='comment-body'>
                                                        <h4 class='comment-author'>Jack Ruler</h4>
                                                        <div
                                                            class='comment-date'
                                                        >March 29, 2014 at 1:38 pm</div>
                                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In magna ligula, faucibus sed ligula ut, venenatis mattis diam. Proin feugiat mollis nibh.</p>
                                                        <div class='text-right weight-600'>
                                                            <a class='comment-reply' href='#'>
                                                                <i class='fa fa-mail-reply'></i> Reply
                        ...
                        <div class='sidebar sidebar-right'>
                            ...
                            <div class='widget widget-tab'>
                                <ul class='nav nav-tabs'>
                                    <li class='active'>
                                        <a href='#popular-tab' data-toggle='tab'>popular</a>
                                    </li>
                                    <li class>
                                        <a href='#recent-tab' data-toggle='tab'>recent</a>
                                    </li>
                                    <li class>
                                        <a href='#comments-tab' data-toggle='tab'>comments</a>
                                    </li>
                                </ul>
                                            ...
                                            <li>
                                                ...
                                                <div class='post-content'>
                                                    <h4 class='entry-title'>
                                                        <a
                                                            href='#'
                                                        >Bulgaria claims to find Europe's 'oldest town'</a>
                                                    </h4>
                                                    <p class='post-meta'>
                                                        <span class='post-meta-author'>
                                                            Posted by
                                                        ...
                                                        <span class='post-meta-date'>
                                                            <a href='#'>
                                                                <i class='fa fa-clock-o'></i> November 14
                                                            </a>
                                                        </span>
                                                    </p>
                                                </div>
                                            ...
                                            <li>
                                                ...
                                                <div class='post-content'>
                                                    <h4 class='entry-title'>
                                                        <a
                                                            href='#'
                                                        >Lorem ipsum dolor sit amet, consectetur claims</a>
                                                    </h4>
                                                    <p class='post-meta'>
                                                        <span class='post-meta-author'>
                                                            Posted by
                                                        ...
                                                        <span class='post-meta-date'>
                                                            <a href='#'>
                                                                <i class='fa fa-clock-o'></i> October 19
                                                            </a>
                                                        </span>
                                                    </p>
                                                </div>
                                            ...
                                            <li>
                                                ...
                                                <div class='post-content'>
                                                    <h4 class='entry-title'>
                                                        <a
                                                            href='#'
                                                        >Should You Ever Skip Giving A Tip?</a>
                                                    </h4>
                                                    <p class='post-meta'>
                                                        <span class='post-meta-author'>
                                                            Posted by
                                                        ...
                                                        <span class='post-meta-date'>
                                                            <a href='#'>
                                                                <i class='fa fa-clock-o'></i> November 21
                                                            </a>
                                                        </span>
                                                    </p>
                                                </div>
                                            ...
                                            <li>
                                                ...
                                                <div class='post-content'>
                                                    <h4 class='entry-title'>
                                                        <a
                                                            href='#'
                                                        >If you are going to use a passage of Lorem Ipsum</a>
                                                    </h4>
                                                    <p class='post-meta'>
                                                        <span class='post-meta-author'>
                                                            Posted by
                                            ...
                                            <li>
                                                ...
                                                <div class='post-content'>
                                                    <h4 class='entry-title'>
                                                        <a
                                                            href='#'
                                                        >you need to be sure there isnâ€™t anything embarra</a>
                                                    </h4>
                                                    <p class='post-meta'>
                                                        <span class='post-meta-author'>
                                                            Posted by
                                                        ...
                                                        <span class='post-meta-date'>
                                                            <a href='#'>
                                                                <i class='fa fa-clock-o'></i> October 18
                                                            </a>
                                                        </span>
                                                    </p>
                                                </div>
                            ...
                            <div class='widget widget-categories'>
                                ...
                                <ul class='category-list clearfix'>
                                    <li>
                                        <a href='#'>Objects</a>
                                        <span class='posts-count'>(19)</span>
                                    </li>
                                    <li>
                                        <a href='#'>Technology</a>
                                    ...
                                    <li>
                                        <a href='#'>Fashion</a>
                                        <span class='posts-count'>(10)</span>
                                    </li>
                                    <li>
                                        <a href='#'>Realtough</a>
                                        <span class='posts-count'>(14)</span>
                                    </li>
                                    <li>
